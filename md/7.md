...
このチュートリアル、日本語がむずかしすぎますが、ちょっとづつ読み進めるよりもとりあえずイチページ全部読むとやることが理解できます。  
（前半説明でやること後半みたいな感じ）
...
ディレクトリに移動したら、コマンドを使って プラグインファイルを作ります。
...
**src/edit.js**  
ブロックがエディター上でがどのように表示されるかを記述します。

**src/editor.scss**  
エディター上で表示されるブロックのCSS。

**src/save.js**  
ブロックが最終的にサイト上でどのように表示されるかを記述します。
...
これを記述するとブロックコントロールと設定サイドバーが勝手に追加されます。  
